                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        ...
                        if(isset($_GET['submit'])){
                            ...
                            $sql .= "std_fname='$std_fname',std_lname='$std_lname',std_ttl_id='$std_ttl_id',std_sid='$std_sid',std_prg_id='$std_prg_id' ";
                    ...
                    <form class="form-horizontal" role="form" name="student_edit" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="std_prg_id" id="std_prg_id" value="<?php echo "$std_prg_id";?>">
                            <div class="col-md-10 col-lg-10">
