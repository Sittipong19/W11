                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                   ...
                   $prj_id = $_REQUEST['prj_id'];
                    if(isset($_GET['submit'])){
                        $prj_name_th   = $_GET['prg_name_th'];
                        $prj_name_en   = $_GET['prg_name_en'];
                        $prj_lct_id   = $_GET['prj_lct_id'];
                        $prj_ptt_id   = $_GET['prj_ptt_id'];
                        $prj_stt_id   = $_GET['prj_stt_id'];
                        include 'connectdb.php';
                        $sql = "update project set ";
                        $sql .= "update project set prj_name_th='$prj_name_th' prj_name_en='$prj_name_en' prj_lct_id='$prj_lct_id' prj_stt_id='$prj_stt_id' prj_ptt_id='$prj_ptt_id'";
                        $sql .="where prj_id='$prj_id' ";
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มประเภทโครงงาน $prj_name_th  เรียบร้อยแล้ว<br>";
                        echo '<a href="project_list.php">แสดงประเภทโครงงานทั้งหมด</a>';
                    }else{
                        include 'connectdb.php';
                        $sql2 = "select * from project where prj_id='$prj_id'";
                        $result2 = mysqli_query($conn,$sql2);
                        $row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC);
                        $fprj_name_th = $row2['prj_name_th'];
                        $fprj_name_en = $row2['prj_name_en'];
                        $fprj_lct_id = $row2['prj_lct_id'];
                        $fprj_ptt_id = $row2['prj_ppt_id'];
                    ?>
                    <br>
                    <form method="get"> 
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10"> 
                                <textarea name="prg_name_th" rows="5" id="prg_name_th"  class="form-control"><?php echo $fprj_name_th;?></textarea>
                                <br>
                            </div>    
                        </div> 
                        <br>   
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-lg-10">
                            <textarea name="prg_name_en" rows="5" id="prg_name_en" class="form-control"><?php echo $fprj_name_en;?></textarea>
                            <br>
                            </div>    
                        </div>
                        <div class="form-group">
