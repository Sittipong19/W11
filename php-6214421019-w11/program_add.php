            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $sql = "insert into program (prg_name) values ('$program_name')";
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มคำนำหน้าชื่อ $program_name เรียบร้อยแล้ว<br>";
                ...
                ?>
                    <form class="form-horizontal" role="form" name="program_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="program_name" class="col-md-2 col-lg-2 control-label">สาขาวิชา</label>
